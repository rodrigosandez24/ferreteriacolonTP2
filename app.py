...
# catalogo = Catalogo(host="localhost", user="root", password="", database="miapp")
catalogo = Catalogo(host='rodrigosandez24.mysql.pythonanywhere-services.com', user='rodrigosandez24', password='root-123456', database='rodrigosandez24$miapp')

# Carpeta para guardar las imagenes
#ruta_destino = './static/imagenes/'
ruta_destino = '/home/rodrigosandez24/static/imagenes/'   #recordar poner / después de imágenes

@app.route("/productos", methods=["GET"])  #GET nos trae los productos
def listar_productos():
    productos = catalogo.listar_productos()  #lista de diccionarios con los productos
    return jsonify(productos)  #convierto a json el diccionario

@app.route("/productos/<int:codigo>", methods=["GET"])  #traigo solo un codigo de productov
